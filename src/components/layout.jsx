...
import { Layout, theme, Flex, Image, Input } from 'antd';
    ...
    return (
        <Layout>
            <Header
                ...
                vertical
            >
                <Flex className="topBarWrapper" style={{width: '100%', height: '30px', background:'#eeeeee', fontSize: '10px', fontWeight: '500', justifyContent:'center'}}>
                    <Flex className="topBar" style={{ alignItems:'center', width: '100%', maxWidth:'1170px', justifyContent:'space-between', marginLeft:'10px',
                        marginRight:'10px'}}>
                        <Flex className="pull-left">
                            <Flex style={{marginRight: '10px'}}> Offers</Flex>
                            <Flex style={{marginRight: '10px'}}> Fanbook</Flex>
                            <Flex style={{marginRight: '10px'}}><i className="icon_mobile_covers mobileIcon"></i> Download App</Flex>
                    ...
                    <Flex
                        ...
                        <Flex style={{alignItems:'center'}}>
                            <Flex style={{marginRight: '20px'}} className='miniIconOnHead' >
                                <Image width='40px' src="https://ik.imagekit.io/itsVaibhav/cb4bac5b-63d7-4e4b-b17b-66a358db499a_TPZRLRQS3.svg"/>
                            </Flex>
                            <Input size="default size" placeholder="Search..." prefix={<SearchOutlined />} variant="filled" style={{fontSize: 'inherit'}} />
                            <Flex style={{marginLeft:'20px'}}>
                                <Flex style={{marginRight: '20px'}}>LOGIN</Flex>
                                <Flex style={{marginRight: '20px'}}><HeartOutlined /></Flex>
                                <Flex style={{marginRight: '20px'}}><ShoppingOutlined /></Flex>
                            </Flex>
                        </Flex>
                    </Flex>
                </Flex>
